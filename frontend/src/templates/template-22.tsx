...
export default function Template22(props: EditableDetailedTopicsProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`grid ${draftTopics.length > 2 ? "grid-cols-2 grid-rows-2" : "grid-cols-2"} gap-6 w-full`}
      >
            ...
            {isEditing ? (
              <>
                ...
                <textarea
                  ...
                  className="w-full text-gray-600 mb-3 outline-none border border-transparent hover:border-gray-300 cursor-text bg-transparent resize-none"
                  rows={2}
                />
